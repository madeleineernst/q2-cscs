...
plugin.methods.register_function(
    ...
    parameters={'css_edges': qiime2.plugin.Str, 'weighted': qiime2.plugin.Bool, 'normalization': qiime2.plugin.Bool, 'cosine_threshold': qiime2.plugin.Float % qiime2.plugin.Range(0., None), 'cpus': qiime2.plugin.Int, 'chunk': qiime2.plugin.Int},
